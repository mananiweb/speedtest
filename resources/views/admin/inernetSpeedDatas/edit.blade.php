...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inernet-speed-datas.update", [$inernetSpeedData->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip') ? 'is-invalid' : '' }}" type="text" name="ip" id="ip" value="{{ old('ip', $inernetSpeedData->ip) }}">
                @if($errors->has('ip'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ip') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dl') ? 'is-invalid' : '' }}" type="text" name="dl" id="dl" value="{{ old('dl', $inernetSpeedData->dl) }}">
                @if($errors->has('dl'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dl') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('upload') ? 'is-invalid' : '' }}" type="text" name="upload" id="upload" value="{{ old('upload', $inernetSpeedData->upload) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ping') ? 'is-invalid' : '' }}" type="text" name="ping" id="ping" value="{{ old('ping', $inernetSpeedData->ping) }}">
                @if($errors->has('ping'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ping') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jitter') ? 'is-invalid' : '' }}" type="text" name="jitter" id="jitter" value="{{ old('jitter', $inernetSpeedData->jitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ispinfo') ? 'is-invalid' : '' }}" type="text" name="ispinfo" id="ispinfo" value="{{ old('ispinfo', $inernetSpeedData->ispinfo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ua') ? 'is-invalid' : '' }}" type="text" name="ua" id="ua" value="{{ old('ua', $inernetSpeedData->ua) }}">
                @if($errors->has('ua'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ua') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lang') ? 'is-invalid' : '' }}" type="text" name="lang" id="lang" value="{{ old('lang', $inernetSpeedData->lang) }}">
                @if($errors->has('lang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lang') }}
                    </div>
