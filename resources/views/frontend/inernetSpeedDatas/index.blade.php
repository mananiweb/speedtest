        ...
        <div class="col-md-12">
            @can('inernet_speed_data_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.inernet-speed-datas.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $inernetSpeedData->id }}">
                                        ...
                                        <td>
                                            @can('inernet_speed_data_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.inernet-speed-datas.show', $inernetSpeedData->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan
