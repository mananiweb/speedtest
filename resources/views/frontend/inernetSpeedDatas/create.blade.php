    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.inernet-speed-datas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dl" id="dl" value="{{ old('dl', '') }}">
                            @if($errors->has('dl'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dl') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="upload" id="upload" value="{{ old('upload', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ping" id="ping" value="{{ old('ping', '') }}">
                            @if($errors->has('ping'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ping') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jitter" id="jitter" value="{{ old('jitter', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ispinfo" id="ispinfo" value="{{ old('ispinfo', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ua" id="ua" value="{{ old('ua', '') }}">
                            @if($errors->has('ua'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ua') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lang" id="lang" value="{{ old('lang', '') }}">
                            @if($errors->has('lang'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lang') }}
                                </div>
